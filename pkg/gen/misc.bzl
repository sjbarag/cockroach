...
MISC_SRCS = [
    ...
    "//pkg/cmd/mirror/ui:cluster-ui.yarn.json.new",
    "//pkg/cmd/mirror/ui:crdb-protobuf-client.yarn.json.new",
    "//pkg/cmd/mirror/ui:db-console.yarn.json.new",
    "//pkg/cmd/mirror/ui:e2e-tests.yarn.json.new",
    "//pkg/cmd/mirror/ui:eslint-plugin-crdb.yarn.json.new",
    "//pkg/cmd/mirror/ui:this.yarn.json.new",
